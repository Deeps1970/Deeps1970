...
const internships = [
  {
    ...
    description:
      "Worked on real-world web development tasks and built responsive, interactive websites using modern frontend technologies.",
  },
  {
    role: "Web Development Intern",
    ...
    description:
      "Gained hands-on experience in MERN stack web development and contributed to collaborative team projects.",
  },
];
