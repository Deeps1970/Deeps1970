...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center pt-16 relative overflow-hidden">
      <SectionGlow
        glows={[
          { x: "30%", y: "20%", color: "indigo", size: "20rem", animation: "float-slow" },
          { x: "70%", y: "70%", color: "green", size: "16rem", animation: "float-slow-reverse" },
        ]}
      />
        ...
        <div className="max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input id="email" name="email" type="email" required className="w-full px-4 py-2.5 text-sm bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent text-foreground placeholder:text-muted-foreground" placeholder="you@example.com" />
            </div>
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-foreground mb-1.5">Message</label>
              <textarea id="message" name="message" rows={5} required className="w-full px-4 py-2.5 text-sm bg-card border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent text-foreground placeholder:text-muted-foreground resize-none" placeholder="Tell me about your project..." />
            </div>
